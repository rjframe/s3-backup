...
SHA512 encryption via pycrypto ensures all data is secure while off-site.
...
** restore.py needs to handle non-archive restores
*** Probably just the choose-files and browse-files subcommands
