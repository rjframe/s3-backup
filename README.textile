...
If you're installing this on public or psuedo-public computers, create sub-accounts and use those keys for enhanced security. Also manage access permissions from AWS - s3backup doesn't yet do this.
