...
restore.py is not nearly complete - all restores must be made manually. The directory structure of backups is preserved so you can just copy/paste the files to restore. restore.py only contains a decryption function right now.

h3. Issues and TODO

* Configuration file instead of storing settings in code
* Encrypt archive / files before upload
** UPDATE: Archives can be encrypted; individual files will come later
